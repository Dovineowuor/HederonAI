...
export default function PitchDeckPage() {
  ...
  const slides = [
    ...
    },
    {
      ...
      subtitle: "Why we built on DLT",
      content: (
        <div className="flex flex-col h-full space-y-6 justify-center">
          <div className="glass p-6 rounded-2xl border border-white/10 bg-zinc-900/60 flex gap-6 items-start">
            <div className="text-5xl mt-2">⛓️</div>
            <div>
              <h3 className="text-2xl font-bold text-white mb-2">Hedera Consensus Service (HCS)</h3>
              <p className="text-xl text-zinc-300">
                Solving the "AI Black Box." Every agent decision, task transition, and output hash is logged immutably. This provides a cryptographically verifiable audit trail of AI decision-making.
              </p>
            </div>
          </div>
          <div className="glass p-6 rounded-2xl border border-white/10 bg-zinc-900/60 flex gap-6 items-start">
            ...
            <div>
              <h3 className="text-2xl font-bold text-white mb-2">Hedera Token Service (HTS)</h3>
              <p className="text-xl text-zinc-300">
                Simulating an autonomous agent economy. We use HTS microtransactions to settle payments between agents (e.g., CEO pays the Marketing Agent), establishing the rails for AI monetary networks.
              </p>
            </div>
          </div>
        </div>
    ...
    {
      id: "slide-5",
      title: "IPFS & Decentralized Outputs",
      subtitle: "Owning your AI collateral",
      content: (
        <div className="flex flex-col h-full justify-center">
          <div className="grid grid-cols-2 gap-8 items-center h-full">
            <div className="space-y-6">
              <p className="text-2xl text-zinc-200 leading-relaxed">
                ExecuAI's <strong>Brainstorm Challenge</strong> flow autonomously builds tangible deliverables, not just text.
              </p>
              <ul className="space-y-4 text-xl text-zinc-300">
                <li className="flex items-center gap-3">✅ <span className="text-white font-medium">Full Codebase ZIPs</span> generated by the Creator Agent.</li>
                <li className="flex items-center gap-3">✅ <span className="text-white font-medium">Business Plan PDFs</span> compiled by the Analyst.</li>
                <li className="flex items-center gap-3">✅ <span className="text-white font-medium">Pitch Presentations</span> mapped by default.</li>
              </ul>
            </div>
            <div className="glass p-8 rounded-3xl border border-white/10 text-center bg-blue-900/20">
              <div className="text-7xl mb-4 text-cyan-400">📦</div>
              <h3 className="text-2xl font-bold text-white mb-3">IPFS Storage Layer</h3>
              <p className="text-lg text-zinc-400">
                All generated assets are pinned natively to IPFS. You own the cryptographic CID pointers eternally, independent of centralized databases.
              </p>
            </div>
          </div>
        </div>
